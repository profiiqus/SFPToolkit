...
class TitleResourceKeyEmptyCheck extends baseCheck_1.BaseCheck {
    check(document) {
        ...
        while ((match = titleResourceKeyRegex.exec(text)) !== null) {
            ...
            const diagnostic = new vscode.Diagnostic(range, `CST-001: The parameter 'TitleResourceKey' is empty and should be assigned a value.`, vscode.DiagnosticSeverity.Warning);

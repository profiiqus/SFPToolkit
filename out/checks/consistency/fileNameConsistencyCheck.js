...
exports.FileNameConsistencyCheck = void 0;
const vscode = __importStar(require("vscode"));
const baseCheck_1 = require("../baseCheck");
const path = __importStar(require("path"));
class FileNameConsistencyCheck extends baseCheck_1.BaseCheck {
    check(document) {
        const diagnostics = [];
...
exports.FileNameConsistencyCheck = FileNameConsistencyCheck;
//# sourceMappingURL=fileNameConsistencyCheck.js.map